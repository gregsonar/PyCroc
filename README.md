...
> Статус: MVP. Обновлено под croc v11 (v11.5.0): флаг `--transport`
...
> Сквозная передача через локальный relay проверена на реальном croc v11.5.0
> и v10.2.7; форматы вывода v8/v9/v10 по-прежнему поддерживаются.
